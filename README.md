...
- [API Reference](#api-reference)
    ...
    - [User API](#user-api)
        ...
        - [getRefereeOfUser(id: IdType, config?: AxiosRequestConfig) => Promise<HttpResponse\<IUserBase[]>>](#getrefereeofuserid-idtype-config-axiosrequestconfig--promisehttpresponseibaseuser)
