...
export const USER_PATH = {
    ...
    APPROVE_QR_CODE_PAIRING_REQUEST: `v1/${REST}/${REST_AUTH}/${REST_PASSWORDLESS}/qrcode/{qrCodeId}/approve`,

    GENERATE_NEW_OTP_FOR_PARING_AUTHENTICATION: `v1/${REST}/${REST_AUTH}/${REST_PASSWORDLESS}/otp/generate`,
    GET_CURRENT_STATUS_OF_OTP_PARING_REQUEST: `v1/${REST}/${REST_AUTH}/${REST_PASSWORDLESS}/otp/{otpCode}`,
    LOGIN_IN_USING_APPROVED_OTP_PARING_REQUEST: `v1/${REST}/${REST_AUTH}/${REST_PASSWORDLESS}/otp/{otpCode}/login`,
    APPROVE_OTP_CODE_PAIRING_REQUEST: `v1/${REST}/${REST_AUTH}/${REST_PASSWORDLESS}/otp/{otpCode}/approve`,

    AUTHENTICATION: `v1/${REST}/auth`,
    CHANGE_PASSWORD: `v1/${REST}/change-password`,
    CHANGE_PASSWORD_BY_USER: `v1/${REST}/{id}/change-password`,
