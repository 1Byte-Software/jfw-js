 ...
 */
export const createAppIntegrationAnalytics = async (
    params: ICreateAppIntegrationAnalyticsParams,
    config?: AxiosRequestConfig,
) => {
    const url = APP_INTEGRATION_ANALYTICS_PATH.CREATE_APP_INTEGRATION_ANALYTICS;
 ...
 */
export const deleteAppIntegrationAnalytics = async (
    id: IdType,
    config?: AxiosRequestConfig,
) => {
 ...
 */
export const getAppIntegrationAnalytics = async (
    id: IdType,
    config?: AxiosRequestConfig,
) => {
    const url = generatePath(
    ...
    const response = await jfwAxios.get<HttpResponse<IAppIntegrationAnalytics>>(
        url,
        config,
    );
 ...
 */
export const getAppIntegrationAnalyticsWithBrand = async (
    config?: AxiosRequestConfig,
) => {
    const url =
 ...
 */
export const updateAppIntegrationAnalytics = async (
    ...
    const response = await jfwAxios.put<HttpResponse<IAppIntegrationAnalytics>>(
        url,
        bodyParams,
        config,
    );
