...
export class AppIntegrationAuthenticationAPI extends AbstractAPI {
     ...
     * @see {@link https://developers.jframework.io/references/api-reference/endpoints/app-integrations/authentication/creates-an-app-integration-authentication}
     */
    public async createAppIntegrationAuthentication(
     ...
     * @param config - Optional axios request configuration object.
     * @see {@link https://developers.jframework.io/references/api-reference/endpoints/app-integrations/authentication/create-an-app-integration-authentication-by-import-file}
     */
    public async createAppIntegrationAuthenticationWithImportFileSettings(
     ...
     */
    public async deleteAppIntegrationAuthentication(
        id: IdType,
        config?: AxiosRequestConfig,
    ) {
     ...
     */
    public async getAppIntegrationAuthentication(
        id: IdType,
        config?: AxiosRequestConfig,
    ) {
        const url = generatePath(
     ...
     */
    public async getAppsIntegrationAuthenticationWithBrand(
     ...
     */
    public async testBuildingAuthenticationURL(
     ...
     */
    public async updateAppIntegrationAuthentication(
        id: IdType,
