...
export class AppIntegrationPaymentGatewayAPI {
     ...
     * @see {@link https://developers.jframework.io/references/api-reference/endpoints/app-integrations/payment-gateway/creates-an-app-integration-payment-gateway}
     */
    public async createAppIntegrationPaymentGateway(
     ...
     */
    public async deleteAppIntegrationPaymentGateway(
        id: IdType,
        config?: AxiosRequestConfig,
    ) {
     ...
     */
    public async getAppIntegrationPaymentGateway(
        id: IdType,
        config?: AxiosRequestConfig,
    ) {
        const url = generatePath(
     ...
     */
    public async getAppsIntegrationPaymentGatewayWithBrand(
        config?: AxiosRequestConfig,
    ) {
        const url =
     ...
     */
    public async testCreatingCheckoutLink(
    ...
    /**
     * # Updates an app integration payment gateway
     *
     ...
     */
    public async updateAppIntegrationPaymentGateway(
        id: IdType,
