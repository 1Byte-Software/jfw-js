...
- Improve `IGetCountriesParams` sortable fields interface.

### Deprecated

- Deprecated `IUserNotification` interface. Please user `INotificationUser` instead.

## [6.9.2]

### Fixed

- Improve nullable fields of JFW Objects.
...
- Fix Path of `getCurrentBrandLinksByType` api.

### Removed

- Remove global error handler in `jfwOptions`.
